...
public class Interfaz4Btn extends JFrame implements ActionListener {
	...
	public Interfaz4Btn() {
		...
		boton1.addActionListener(this);// implementa la interface ActionListener q espera cuando este(this) boton
										// genere un Eveto

	}

	// metodo de la interfaz ActionListener para escribir la logica del envento q
	// debe capturar
	@Override
	public void actionPerformed(ActionEvent e) {
		// getSource() metodo ActionEvent recuoera el evento q se genero en el boton
		// ...verifica q boton se utilizo q en este caso solo hay 1
		if (e.getSource() == boton1) {
			System.exit(0);// indicamos al programa q si se toca el boton (evento) se cierra el programa
							// con el metodo System.exit(0);
		}
